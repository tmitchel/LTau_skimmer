...
etau_tree2017::etau_tree2017(TTree* Original, TTree* itree, bool IsMC, bool IsEmbed, bool IsSignal, Int_t rec)
    : tree(itree),
      ...
      isEmbed(IsEmbed),
      isSignal(IsSignal),
      tfes("2017ReReco", "DeepTau2017v2p1VSe", "ltau_skimmer/ROOT/data/", "et", isEmbed),
      recoil(rec),
      era(2017) {}
...
void etau_tree2017::do_skimming(TH1F* cutflow) {
    ...
    for (auto ievt = 0; ievt < nevt; ievt++) {
        ...
        auto Ele27_emb = in->eMatchEmbeddedFilterEle27 || fabs(ele.Eta()) > 1.479;
...
//////////////////////////////////////////////////////////////////
TTree* etau_tree2017::fill_tree(RecoilCorrector recoilPFMetCorrector, MEtSys metSys) {
