...
public:
  ...
  Int_t njets_JESUp, njetspt20_JESUp, njets_JESDown, njetspt20_JESDown;
  Float_t jetVeto30, eZTTGenMatching, tZTTGenMatching, j1ptUp, j1ptDown, j2ptUp, j2ptDown;
  Float_t Rivet_nJets30, Rivet_higgsPt;

  Float_t eMatchesEle27Filter, eMatchesEle32Filter, eMatchesEle35Filter, eMatchesEle24Tau30Filter, eMatchesEle27Path, eMatchesEle32Path, eMatchesEle35Path, eMatchesEle24Tau30Path, Ele24Tau30Pass, Ele27WPTightPass, Ele32WPTightPass, Ele35WPTightPass;

  Float_t GenWeight, genpX, genpY, vispX, vispY, genpT, genM, type1_pfMetEt, type1_pfMetPhi, metSig, metcov00, metcov01, metcov10, metcov11, NUP, rho, eMVANoisoWP80, eMVANoisoWP90,
      ...
      py_2, pz_2, ePt, eMass, ePhi, eEta, tPhi, tEta, tMass, tPt, mjj, vbfDeta, 
      ...
      eMVANonTrigWP80, ePassesConversionVeto, eMissingHits, e_t_DR, tRerunMVArun2v1DBoldDMwLTVLoose, dielectronVeto,
...
void etau_tree::do_skimming(TH1F* cutflow) {
  ...
  for (auto ievt = 0; ievt < nevt; ievt++) {
    ...
    auto Cross =  eMatchesEle24Tau30Filter && eMatchesEle24Tau30Path && Ele24Tau30Pass;
...
void etau_tree::set_branches() {
  ...
  tree->Branch("eMVANoisoWP90", &eMVANoisoWP90, "eMVANoisoWP90/F");
