...
class mutau_tree2017 : public virtual base_tree {
   ...
   public:
    ...
    // Member functions
    mutau_tree2017(TTree* orig, TTree* itree, bool isMC, bool isEmbed, bool IsSignal, Int_t rec);
...
//////////////////////////////////////////////////////////////////
mutau_tree2017::mutau_tree2017(TTree* Original, TTree* itree, bool IsMC, bool IsEmbed, bool IsSignal, Int_t rec)
    : tree(itree),
      original(Original),
      ...
      isEmbed(IsEmbed),
      isSignal(IsSignal),
      tfes("2017ReReco", "DeepTau2017v2p1VSe", "ltau_skimmer/ROOT/data/", "mt", isEmbed),
      recoil(rec),
      era(2017) {}
...
void mutau_tree2017::do_met_corr_nom(Float_t sf, TLorentzVector tau, TLorentzVector* met) {
