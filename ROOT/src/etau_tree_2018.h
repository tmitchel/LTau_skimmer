...
Float_t etau_tree2018::get_tes_sf(Float_t decayMode) {
  if (decayMode == 0) {
    return  tes_dm0_sf;
  } else if (decayMode == 1) {
    return tes_dm1_sf;
...
Float_t etau_tree2018::get_efake_sf(Float_t decayMode) {
  if (decayMode == 0) {
    return efake_dm0_sf;
  } else if (decayMode == 1) {
    return efake_dm1_sf;
...
Float_t etau_tree2018::get_mfake_sf(Float_t decayMode) {
  if (decayMode == 0) {
    return mfake_dm0_sf;
  } else if (decayMode == 1) {
    return mfake_dm1_sf;
...
void etau_tree2018::do_met_corr_nom(Float_t decayMode, energy_scale escale, TLorentzVector tau, TLorentzVector* met) {
  double sf(1.);
  if (escale == tes) {
