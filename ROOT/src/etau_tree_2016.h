...
class etau_tree2016 : public virtual base_tree {
   ...
   public:
    ...
    // Member functions
    etau_tree2016(TTree* orig, TTree* itree, bool isMC, bool isEmbed, bool IsSignal, Int_t rec);
...
//////////////////////////////////////////////////////////////////
etau_tree2016::etau_tree2016(TTree* Original, TTree* itree, bool IsMC, bool IsEmbed, bool IsSignal, Int_t rec)
    : tree(itree),
      original(Original),
...
void etau_tree2016::do_met_corr_nom(Float_t sf, TLorentzVector tau, TLorentzVector* met) {
