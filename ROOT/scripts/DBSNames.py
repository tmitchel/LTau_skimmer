...
ntuples = [ifile for ifile in glob(dir+'/*/*')]
...
datasets = {
  ...
  '/VVTo2L2Nu_13TeV_amcatnloFXFX_madspin_pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM': [],
  ...
  '/WWToLNuQQ_NNPDF31_TuneCP5_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v1/MINIAODSIM': [],
  ...
  '/WZTo1L3Nu_13TeV_amcatnloFXFX_madspin_pythia8_v2/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM': [],
...
for ds, found in datasets.iteritems():
  output = os.popen('dasgoclient --query="file dataset=' + ds + '"')
  files = output.readlines()
  for ntuple in ntuples:
    fileHash = ntuple.split('.root')[0].split('make_ntuples_cfg-')[-1]
    for ifile in files:
      if fileHash in ifile:
        found.append(ntuple)
        files.remove(ifile)
